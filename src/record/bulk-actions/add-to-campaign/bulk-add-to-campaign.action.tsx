...
import {type BulkRecordActionBatchRunOutcome, showDialog, showToast} from "attio/client"
import {pluralize} from "../../../utils/pluralize"
import addPeopleToCampaign from "./add-people-to-campaign.server"
import BulkAddToCampaignDialog, {type BulkAddFormValues} from "./bulk-add-to-campaign-dialog"
...
export const addToCampaignBulkAction: App.Record.BulkAction = {
    id: "add-to-campaign",
    ...
    onTrigger: async ({runRecordBatches}) => {
        ...
        const outcome = await runRecordBatches(
            ...
            (batch) => processBatch({campaignId, recordIds: batch.recordIds})
        )
